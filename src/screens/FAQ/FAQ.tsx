...
export const faqItems = [
	...
	},
	{
		...
		text:
			'The sampling kit contains a detailed instruction page with how to collect leaves and the size of leaf required, Ziploc baggies to collect leaves in, and a pre-paid return mailing envelope for you to ship the samples back to us.',
		isForSamples: true,
	},
	{
